...
public class Logicos extends javax.swing.JInternalFrame {
    ...
    private void bVerificar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar1ActionPerformed
        ...
        try {
            ...
            if (resp) {
                ...
                JOptionPane.showMessageDialog(this, "No son Iguales.", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Digite los numeros.", "Error", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void bCalcular2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular2ActionPerformed
        ...
        try {
            ...
            if (num1 == num2) {
                JOptionPane.showMessageDialog(this, "Digite dos numeros diferentes", "Error", JOptionPane.WARNING_MESSAGE);
            } else {
                if (resp) {
                    JOptionPane.showMessageDialog(this, num2 + " Es Mayor", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(this, num1 + " Es Mayor.", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
                }
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Digite los numeros.", "Error", JOptionPane.WARNING_MESSAGE);
    ...
    private void bCalcular3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular3ActionPerformed
        ...
        try {
            ...
            if (num1 == num2) {
                ...
                if (resp) {
                    JOptionPane.showMessageDialog(this, num1 + " Es Menor.", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(this, num2 + " Es Menor.", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
                }
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Digite los numeros.", "Error", JOptionPane.WARNING_MESSAGE);
    ...
    private void bCalcular4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular4ActionPerformed
        ...
        try {
            ...
            if (num1 == num2) {
                ...
                if (resp) {
                    JOptionPane.showMessageDialog(this, "Verdadero", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(this, "Falso", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
                }
            }
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Digite los numeros.", "Error", JOptionPane.WARNING_MESSAGE);
    ...
    private void bVerificar6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar6ActionPerformed
        // TODO add your handling code here:
        if (tfCaracter1.getText().length() > 0 && tfCaracter2.getText().length() > 0) {
            try {
                String car1 = tfCaracter1.getText();
                String car2 = tfCaracter2.getText();
                boolean resp = logico.SsonIguales(car1, car2);
                if (resp) {
                    JOptionPane.showMessageDialog(this, "Son Iguales.", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(this, "No son Iguales.", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
                ...
                JOptionPane.showMessageDialog(this, "Digite los caracteres.", "Error", JOptionPane.WARNING_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(this, "Digite los caracteres", "Error", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void bVerificar7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar7ActionPerformed
        // TODO add your handling code here:
        if (tfCaracter3.getText().length() > 1 && tfCaracter4.getText().length() > 1) {
            try {
                String car1 = tfCaracter3.getText();
                String car2 = tfCaracter4.getText();
                boolean resp = logico.SsonIguales(car1, car2);
                if (resp) {
                    JOptionPane.showMessageDialog(this, "Son Iguales.", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
                } else {
                ...
                JOptionPane.showMessageDialog(this, "Digite mas de un caracter.", "Error", JOptionPane.WARNING_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(this, "Digite al menos 2 caracteres", "Error", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void bVerificar8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar8ActionPerformed
        // TODO add your handling code here:
        if (tfCadena1.getText().length() > 0 && tfCadena2.getText().length() > 0) {
            try {
                String cad1 = tfCadena1.getText();
                String cad2 = tfCadena2.getText();
                boolean resp = logico.SsonIguales(cad1, cad2);
                if (resp) {
                    JOptionPane.showMessageDialog(this, "Son Iguales.", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(this, "No son Iguales.", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
            ...
            JOptionPane.showMessageDialog(this, "Digite la cadena", "Error", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void bCalcular9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular9ActionPerformed
        // TODO add your handling code here:
        if (tfCadena3.getText().length() > 0 && tfCadena4.getText().length() > 0) {
            try {
                String cad1 = tfCadena3.getText();
                String cad2 = tfCadena4.getText();
                boolean resp = logico.CesMayor(cad1, cad2);
                if (logico.CsonIguales(cad1, cad2)) {
                    JOptionPane.showMessageDialog(this, "Son Iguales, Digite una cadena diferente de otra", "Error", JOptionPane.WARNING_MESSAGE);
                } else {
                    if (resp) {
                        JOptionPane.showMessageDialog(this, cad2 + " Es Mayor", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(this, cad1 + " Es Mayor.", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
                    }
                }
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(this, "Digite los numeros.", "Error", JOptionPane.WARNING_MESSAGE);
    ...
    private void bVerificar10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bVerificar10ActionPerformed
        // TODO add your handling code here:
        try {
                Double num1 = Double.parseDouble(tfNum11.getText());
                boolean resp = logico.esNegativo(num1);
                if (resp) {
                    JOptionPane.showMessageDialog(this, num1 + " Es negativo.", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
                } else {
                     JOptionPane.showMessageDialog(this, num1 + " Es positivo.", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
                }
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(this, "Digite los numeros.", "Error", JOptionPane.WARNING_MESSAGE);
            }
